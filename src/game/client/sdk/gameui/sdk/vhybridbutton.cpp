	...
	switch ( curState )
	{
		case Enabled:
			...
			if ( m_nStyle == BUTTON_RED || m_nStyle == BUTTON_REDMAIN )
			{
				...
				col.SetColor( 228, 50, 50, 255 ); // atrblizzard
			}
			else if ( m_nStyle == BUTTON_ALIENSWARMMENUBUTTON || m_nStyle == BUTTON_ALIENSWARMMENUBUTTONSMALL )
			{
				//col.SetColor( 135, 170, 193, 255 );
				col.SetColor( 126, 0, 0, 255 );
			}
			else if ( m_nStyle == BUTTON_MAINMENU || m_nStyle == BUTTON_MAINMENUSMALL )
			{
				col.SetColor( 126, 0, 0, 255 );
			}
			else
			{
				...
				col.SetColor( 230, 0, 0, 255 );
			}
			break;
		case Disabled:
			//col.SetColor( 88, 97, 104, 255 );
			//col.SetColor( 65, 74, 96, 255 );
			col.SetColor( 74, 40, 40, 255 ); //atrblizzard
			bDrawText = true;
			bDrawGlow = false;
			break;
		case FocusDisabled:
